...
*/
            ...
            try {
                ...
                try {
                    if (entity != null) {
                        ...
                        logger.info("[HttpUtils Post]Debug response, url : {}  , params : {}, response string : {} ,time : {}",
                                url, pairs, str, s2 - s1);
    ...
    public static String postJson(String url, JSON data, String encode,int timeOut) {
        String responseString = null;
        if(timeOut == 0) {
    ...
    public static String post(String url, List<NameValuePair> pairs, LinkedHashMap<String, String> headers) {
        ...
        try {
            ...
            if (MapUtils.isNotEmpty(headers)) {
                Iterator<Map.Entry<String, String>> entryKeyIterator = headers.entrySet()
                        .iterator();
