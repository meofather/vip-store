...
<div class="tab-content">
	...
	<!-- END SAMPLE TABLE PORTLET-->
            ...
            <input type = "hidden" id="loanPeriods" name="loanPeriods" value="${(applyApproveTask.loanPeriods)!}">
            <input type = "hidden" id="creditMoney" name="creditMoney" value="${(applyApproveTask.creditMoney)!}">
